...
export default function CreateGeneralOffer() {
    ...
    const [state, setState] = useState<{ validated: boolean, formState: FormState, formError: FormError }>({
        validated: false,
        formState: {...initialState, offerCategory: 'Offer', offerType: 'CasinoOffer'},
        ...
        axios
            ...
            .then((response) => {
                ...
                const dataToSend = {
                    ...
                    message: 'General Offer has been successfully saved',
            ...
            .catch((error) => {
                console.error('General Offer Creation failed:', error);
    ...
    return (
        <>
            <Form title="Create General Offer" validated={state.validated}>
